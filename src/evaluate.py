    ...
    def search_parameter(self):
        ...
        for category in range(4):
            ...
            if self.args.output == 0:
                pbounds = {'thres_seg': (0.2, 0.7), 'size_seg' : (1000, 6000)}
            elif self.args.output == 1:
                pbounds = {'thres_seg': (0.2, 0.7), 'size_seg' : (1000, 6000), 'thres_oth':(0, 0.7), 'size_oth':(0, 6000)}
            ...
            if self.args.test_run or self.args.epoch < 5:
                ...
                optimizer.maximize(init_points = 20, n_iter = 130)
